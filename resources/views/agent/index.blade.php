                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered table-data-div table-condensed table-striped table-hover" style="margin-top: 10px !important; ">
                            ...
                            @if (count($receiveds)>0)
                                ...
                                <tr>  
                                    <td><a href="{{route('school.payments.indexlist',$received->school->code)}}" class="href"><code title="{{$received->school->name}}" class="popRight">{{ $received->school->short_name }}</code></a></td>
