    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. route('academic.certificate.create').'">'. trans('Certificate').'</a> / <a href="'. route('academic.tc.create').'">'. trans('TC').'</a> / <b>'.trans('Edit').'<b>'])
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tc_admissionid" id="tc_admissionid"
                                           readonly value="{{$tc->student->student_code}}">
                                </div>

                                <div class="form-group">
                                    <label for="tc_fname"> @lang('Father Name')</label>
                                    <input type="text" class="form-control" id="tc_fname" name="tc_fname"
                                           value="{{$tc->student->studentInfo->father_name}}" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tc_dob"
                                           name="tc_dob" value="{{$tc->student->studentInfo->birthday}}" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="date" name="date" value="{{$tc->date}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="studentname" name="studentname"
                                           value="{{$tc->student->name}}" readonly>
                                </div>

                                <div class="form-group">
                                    <label for="tc_mname"> @lang('Mother Name')</label>
                                    <input type="text" class="form-control" id="tc_mname" name="tc_mname"
                                           value="{{$tc->student->studentInfo->mother_name}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="date_lastclass"> @lang('Date of last class in the school')</label>
                                    <input type="text" class="form-control" id="date_lastclass" name="date_lastclass"
                                           value="{{$tc->date_lastclass}}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="remark"> @lang('Any other remarks')</label>
                                    <input type="text" class="form-control" id="remark" name="remark"
                                           value="{{$tc->remark}}" readonly>
                                </div>
