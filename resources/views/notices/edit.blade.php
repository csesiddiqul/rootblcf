    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. route('school.website').'">'. trans('Website Settings').'</a> / <a href="'. route('academic.notice.index').'">'.trans('Notice') .'</a> / <b>'. trans('Edit').'<b>'])
                @include('components.sectionbar.frontmanagement-bar')
                <div class="panel panel-default">
                    <div class="panel-body pl-0 pr-0">
                        <form method="POST" id="registerForm"
                              action="{{ route('academic.notice.update',$notice->id) }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="description" class="form-control rounded-0 ckeditor" id="n_description"
                                          rows="5">{{$notice->description}}</textarea>
                            ...
                            <div class="col-md-2 text-center">
                                <a href="{{route('academic.notice.index')}}" class="{{btnClass()}}">@lang('Cancel')</a>
                            </div>
                        </form>
                </div>
                </div>
