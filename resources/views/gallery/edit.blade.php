    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. route('school.website').'">'. trans('Website Settings').'</a> / <a href="'. route('academic.gallery.index').'">'.trans('Gallery') .'</a> / <b>'. trans('Edit').'<b>'])
                    ...
                    <div class="panel-body pl-0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                <label for="description">@lang('Description')</label>{!! Form::textarea('description', NULL, array('rows' => '5','id' => 'description', 'required', 'class' => 'form-control', 'placeholder' => trans('Description'),'rows'=>'3')) !!}
