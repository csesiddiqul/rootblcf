    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. route('school.website').'">'. trans('Website Settings').'</a> / <a href="'. route('academic.testimonial.index').'">'.trans('Testimonial') .'</a> / <b>'. trans('Edit').'<b>'])
                    ...
                    <div class="panel-body pl-0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('message') ? ' has-error' : '' }}">
                                <label for="message">@lang('Message')</label>{!! Form::textarea('message', NULL, array('rows' => '5','id' => 'message', 'required', 'class' => 'form-control', 'placeholder' => trans('Message'))) !!}
