    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content"> 
            <div class="modal-header">
                ...
                <span id="table_name">{{$table_name}}</span>
                <span id="table_id">{{$table_id}}</span>
                <span id="table_field">{{$table_field}}</span>
            ...
            <div class="modal-footer">
                ...
                <button class="btn crop_image btn-sm" id="uploadUdated"><span id="imgapply">Update</span></button>
