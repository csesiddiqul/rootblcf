    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. url('users/'.Auth::user()->school->code.'/1/0').'">'. trans('Students').'</a> / <a href="'. route('academic.house.index').'">'.trans('Student '.(school('country')->code == 'SG' ? 'Branch' : 'House')) .'</a> / <b>'. trans('Add').'<b>'])
