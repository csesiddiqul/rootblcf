    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. url('users/'.Auth::user()->school->code.'/1/0').'">'. trans('Students').'</a> / <a href="'. route('academic.house.index').'">'.trans('Student '.(school('country')->code == 'SG' ? 'Branch' : 'House')) .'</a> / <b>'. trans('Show').'<b>'])
                        ...
                        @if (count($house->studentInfo)>0)
                            <div class="table-responsive">
                                <table class="table table-bordered table-data-div table-condensed table-striped table-hover"
                                    ...
                                    <tbody>
                                    @foreach ($house->studentInfo as $key=>$student_info)
                                        <tr>
