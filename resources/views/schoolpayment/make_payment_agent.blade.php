        ...
        <div class="col-md-10" id="main-container">
            <div class="panel panel-default col-sm-12"> 
                ...
                <div class="panel-body p-0">  
                    <h5 class="">
                        <i><b>Service charge has been paid till 
                            <code>
                    ...
                    <div class="col-md-6 col-sm-6 box_detail">
                        ...
                        <h5 class="h5_detail"> 
                            <div class="checkbox {{Session::has('checked')?'form-group has-error':''}}"> 
                              <label><input type="checkbox" value="yes" name="percentage" id="percentage">Keep your percentage (<i>If you want to pay without your percentage.</i>)</label>
                            </div>  
                        </h5>
...
@push('script')
    ...
    <script>
        $(document).on("change", "#percentage", function() {
            var checkmonth = document.querySelector('input[name="tillmonth"]:checked').value; 
            if(this.checked) { 
            ...
            var totla_stdnt = '{{$totla_stdnt}}';
            var per_stdnt = '{{$per_stdnt}}';
            var total_amount = (totla_stdnt*per_stdnt)*checkmonth;
            var main = parseFloat(total_amount).toFixed(2); 
            var dec = disc / 100; 
            ...
            $('.pr4 span').text(parseFloat(amount).toFixed(2));
            $('.pr5 span').text(tran_fee);
            var total_amount = parseFloat(parseFloat(amount) + parseFloat(tran_fee)).toFixed(2);
            $('.pr6 span').text(total_amount);
        }); 
    </script> 
@endpush
@endsection