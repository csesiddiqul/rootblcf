            ...
            <div class="row mb-30">
                <div class="col-lg-8 col-md-12">
                    <div class="detail-img">
                        <img src="{{asset('public/images/courses/courses-details.jpg')}}" alt="Courses Images"/>
                        ...
                        <div class="course-instructor">
                            <div class="row">
                                <div class="col-md-6 mobile-mb-20">
                                    <h3 class="instructor-title">COURSE <span class="primary-color">INSTRUCTOR</span>
                                    </h3>
                                    <div class="instructor-inner">
                                        <div class="instructor-img">
                                            <img src="{{asset('public/images/teachers/2.jpg')}}" alt="Teachers Images"/>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <h3 class="instructor-title">BASIC <span class="primary-color">INFORMATION</span>
                                    </h3>
                    ...
                    <div class="course-desc">
                        ...
                        <div class="desc-text">
                            <p>
                                ...
                                suffered altera tion in some form, by injected humour, or randomised words which don't
                                look even slightly believable. If you are going to use a passage of Lorem Ipsum
                            </p>
                            <p>
                                There are many variations of passages of Lorem Ipsum available, but the majority have
                                suffered altera tion in some form, by injected humour
                            </p>
                            <p>
                                There are many variations of passages of Lorem Ipsum available, but the majority have
                                suffered altera tion in some form, by injected humour, or randomised words which don't
                                look even slightly believable. If you are going to use a passage of Lorem Ipsumor
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="sidebar-area">
                        ...
                        <div class="latest-courses">
                            ...
                            <div class="post-item">
                                <div class="post-img">
                                    <a href="courses-details.html"><img src="{{asset('public/images/blog-details/sm1.jpg')}}" alt=""
                                                                        title="News image"></a>
                                </div>
                                <div class="post-desc">
                            ...
                            <div class="post-item">
                                <div class="post-img">
                                    <a href="courses-details.html"><img src="{{asset('public/images/blog-details/sm2.jpg')}}" alt=""
                                                                        title="News image"></a>
                                </div>
                                <div class="post-desc">
                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
                            ...
                            <div class="post-item">
                                <div class="post-img">
                                    <a href="courses-details.html"><img src="{{asset('public/images/blog-details/sm3.jpg')}}" alt=""
                                                                        title="News image"></a>
                                </div>
                                <div class="post-desc">
                                    <h4><a href="courses-details.html">Raken develops reporting The software</a></h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="rs-carousel owl-carousel" data-loop="true" data-items="2" data-margin="30"
                             data-autoplay="true" data-autoplay-timeout="8000" data-smart-speed="1200" data-dots="false"
                            ...
                            <div class="testimonial-item">
                                <div class="testi-img">
                                    <img src="{{asset('public/images/testimonial/1.jpg')}}" alt="Jhon Smith">
                                </div>
                                <div class="testi-desc">
                                    ...
                                    <p>
                                        Etiam non elit nec augue tempor gravida et sed velit. Aliquam tempus eget lorem
                            ...
                            <div class="testimonial-item">
                                <div class="testi-img">
                                    <img src="{{asset('public/images/testimonial/2.jpg')}}" alt="Jhon Smith">
                                </div>
                                <div class="testi-desc">
                            ...
                            <div class="testimonial-item">
                                <div class="testi-img">
                                    <img src="{{asset('public/images/testimonial/3.jpg')}}" alt="Jhon Smith">
                                </div>
                                <div class="testi-desc">
                                    <h4 class="testi-name">Aliana D’suza</h4>
                                    <div class="cl-client-rating">
                            ...
                            <div class="testimonial-item">
                                <div class="testi-img">
                                    <img src="{{asset('public/images/testimonial/4.jpg')}}" alt="Jhon Smith">
                                </div>
                                <div class="testi-desc">
                                    <h4 class="testi-name">Aliana D’suza</h4>
                                    <div class="cl-client-rating">
                            ...
                            <div class="testimonial-item">
                                <div class="testi-img">
                                    <img src="{{asset('public/images/testimonial/5.jpg')}}" alt="Jhon Smith">
                                </div>
                                <div class="testi-desc">
                                    <h4 class="testi-name">Aliana D’suza</h4>
                                    <div class="cl-client-rating">
