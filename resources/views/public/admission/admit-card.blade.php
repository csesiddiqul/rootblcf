    ...
    <section>
        <div class="container ">
            <div class="admit-card1 " id="SelectorToPrint">
                                ...
                                <!--  left logo end  -->
                                    ...
                                    <div class="col-sm-6 text-center">
                                        <div class="text-center">
                                            ...
                                            @else
                                                <h2 class="margin">{{school('name')}}</h2>
                                            @endif
                                ...
                                <div class="col-sm-6 padding_bottom">
                                    <table class="table ">
                                        ...
                                        @if($admitTemplete->is_name == '1')
                                            <tr>
                                                <td style="width: 35%;"><b>@lang('Student Name') <span class="float-right">:</span></b></td>
                                                <td style="width: 65%">{{$input['name']??''}}</td>
                                            </tr>
                                        @endif
                                        @if($admitTemplete->is_admission_id == '1')
                                            <tr>
                                                <td><b>@lang('Admission Roll')<span class="float-right">:</span></b>
                                                </td>
                                                <td>{{$input['roll']??''}}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @if($admitTemplete->is_section == '1')
                                            <tr>
                                                ...
                                                <td>{{getSessionById($input['section_id'],'name')}}</td>
                                            </tr>
                                        @endif
                                ...
                                <div class="col-sm-6 padding_bottom">
                                    <table class="table ">
                                        ...
                                        @if($admitTemplete->is_fname == '1')
                                            <tr>
                                                <td style="width: 35%"><b>@lang('Father Name')<span class="float-right">:</span></b>
                                                </td>
                                                <td style="width: 65%;">{{$input['father_name']??''}}</td>
                                            </tr>
                                        @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <b>
                                                        ...
                                                        {{isset($input['perpostoffice']) ? (', '.$input['perpostoffice']) : ''}}
                                                        {{isset($input['preThana']) ? (', '.getThanaName($input['preThana'])) : ''}}
                                                        {{isset($input['preDistrict']) ? (', '.getDistrictName($input['preDistrict'])) : ''}}
                                                        {{isset($input['perpostcode']) ? ('- '.$input['perpostcode']) : ''}}
                                                    </b>
                                                </td>
                                            </tr>
                                        @endif
                                        ...
                                        @if($admitTemplete->is_class == '1')
                                            <tr>
                                                <td><b>{{school('country')->code == 'BD' ? 'Class' : 'Enroll In'}} <span
                                                                class="float-right">:</span></b></td>
                                                <td>
                                                    {{getClass($input['class_id'],'name')}}</td>
                                            </tr>
                                        @endif
                                        @if($admitTemplete->is_section == '1')
                                            <tr>
                    ...
                    <div class="BoxF   mar-bot ">
                        <div class="col-sm-12 text-justify">
                            <h5 class="margin">@lang('Examination Center :') <span
                                        class="font">{{$admitTemplete->examcenter}}</span></h5>
                        </div>
                    </div>
                    {{--
                ...
                <div align="center" style="font-size: 8px;margin-bottom: -15px;margin-top: -8px;"
                     class="d-print-block d-none">
                    Developed by : {{school('reseller')->name}}
                </div>
            </div>
        </div>
    </section>
