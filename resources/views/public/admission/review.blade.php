                ...
                <div class="col-sm-12" id="main-container">
                    <form id="applyform" method="post" action="{{route('submit.admission')}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" align="center">
                                ...
                                <p class="margin">{{school('country')->code == 'BD' || 'SG' ? trans('Admission Class') : trans('Enroll In')}}
                                    : {{getClassBySection($input['class_id'],'name')}}</p>
                                <span style="text-decoration: underline">@lang('Reviewing Admission form')</span>
                            </div>
                            <div class="col-sm-3">
                                <img src="{{$input['url']??''}}"
                                     class="profile-user-img img-responsive img-thumbnail float-right"
                                ...
                                <div class="row">
                                        ...
                                        <table class="table ">
                                            ...
                                            <tr>
                                                <td>@lang('Mobile') <span class="float-right">:</span>
                                                    @if(school('country')->code == 'BD')    <br>
                                                    <code>@lang('You will receive all SMS to this number')</code> @endif
                                                </td>
                                                <td>{{$input['mobile']??''}}</td>
                                            </tr>
                                            ...
                                            @elseif(school('country')->code == 'SG')
                                                @php $previous_class = 'Branch'; @endphp
                                            @else
                                    ...
                                    <div class="col-sm-6">
                                        <table class="table">
                                            ...
                                            @endif
                                            <tr>
                                                <td style="width: 62%;">{{school('country')->code == 'BD' || 'SG' ? trans('Class') : 'Enroll In'}}
                                                    <span class="float-right">:</span></td>
                                                <td style="width: 38%;">{{getClassBySection($input['class_id'],'name')}}</td>
                                            </tr>
                                            <tr>
                            ...
                            <fieldset class="scheduler-border col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 ">
                                        <table class="table for_leftside">
                                            <tr>
                                                <td style="width: 62%;">@lang('Name') <span
                                                            class="float-right">:</span>
                                                </td>
                            ...
                            @if(school('country')->code == 'BD')
                                ...
                                <div class="col-md-6 print_left_50 tdSpeace ppr0 pl-0 {{useragentMobile() ? 'pr-0' : ''}}">
                                    <fieldset class="scheduler-border col-md-12">
                                        ...
                                        <table class="table ">
                                            <tr>
                                                <td style="width:62%;">@lang('Village') <span
                                                            class="float-right">:</span></td>
                                                <td style="width:38%;">{{$presentAddress}}</td>
                                            </tr>
                                            <tr>
                                                <td style="width:62%;">@lang('Post Code') <span
                                                            class="float-right">:</span></td>
                                            ...
                                            <tr>
                                                <td style="width:62%;">@lang('Thana') <span
                                                            class="float-right">:</span>
                                                </td>
                                                <td style="width:38%;">{{$preThana}}</td>
                                            </tr>
                                            <tr>
                                                <td style="width:62%;">@lang('District') <span
                                                            class="float-right">:</span></td>
                                                <td style="width:38%;">{{$preDistrict}}</td>
                                            </tr>
                                            <tr>
                                                <td style="width:62%;">@lang('Division') <span
                                                            class="float-right">:</span></td>
                                ...
                                <div class="col-md-6 print_right_50 tdSpeace ppr0  pr-0  {{useragentMobile() ? 'pl-0' : ''}}">
                                    <fieldset class="scheduler-border col-md-12">
                                        ...
                                        <table class="table ">
                                            ...
                                            <tr>
                                                <td style="width:60%;">@lang('Post Code') <span
                                                            class="float-right">:</span></td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 ">
                                                <table class="table for_rightside">
                                                    ...
                                                    <tr>
                                                        <td style="width: 62%;">@lang('City') <span
                                                                    class="float-right">:</span>
                                                        </td>
                        ...
                        <div class="form-group  text-center d-print-none">
                            <a class="btn btn-primary" id="for_back" href="{{route('apply.admission')}}?accept=false">
                                @lang('Back')</a>
                            <button class="btn  btn-primary" type="button"
                                    onclick="confirmSubmit()">@lang('Submit')</button>
                        </div>
                    </form>
