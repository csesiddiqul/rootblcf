@extends('public.layout.public',['title' => transMsg($meritMenu->name) ])
@section('sliderText')
    <h1 class="page-title">{!! transMsg($meritMenu->name) !!}</h1>
@endsection
@section('content')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 mt-2">
                    @if(foqas_setting('admission_result') == 1)
                        @if ($published_status)
                                    ...
                                    <div class="">
                                        <div align="center" class="d-print-block">
                                            ...
                                            @foreach ($results[$key] as $result)
                                                ...
                                                @php $limit = $result->section->add_total; @endphp
                                                @break
                                            @endforeach
                                            <h5 class="underline">{!! transMsg($meritMenu->name) !!}</h5>
                                        </div>
