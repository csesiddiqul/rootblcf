@extends('public.layout.public',['title' => transMsg('Download Admit Card') ])
@section('sliderText')
    <h1 class="page-title">@lang('Download Admit Card')</h1>
@endsection
@section('content')
                ...
                <div class="col-md-12 " style="">
                    @if(foqas_setting('admission_student') == 1)
                        ...
                        <form class="form-horizontal" id="downloadApp" method="POST"
                              action="{{route('admitcard.view')}}">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <h3 style="    padding-top: 25px;"
                                    class="sufya text-center">@lang('Download Admit Card')</h3>
