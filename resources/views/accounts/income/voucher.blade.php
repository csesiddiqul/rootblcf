    ...
    <ul class="full_con">
        ...
        <li class="bor_r_d">
            <div id="page">
                    ...
                    <div align="center" class="con_margin">
                        ...
                        <div align="center" class="slip-content">
                            ...
                            <p class="font_10 special-box lucida"
                               style="font-family: sans-serif !important;text-align:center !important;font-size: 18px !important; margin-bottom:8px !important;margin-top:110px !important;">MONEY RECEIPT</p>
                        </div>
                    </div>
                ...
                <section>
                    <div class="con_margin">
                        <table class="table" border="1" style="font-family: sans-serif !important; font-size:15px;">
                            ...
                            <tr>
                                <td>1</td>
                                <td>{{$voucher->accountSector->name}}</td>
                ...
                <footer>
                    <div class="con_margin">
                        <div class="sans" style="text-transform: capitalize">
                            In Sum of SG
                            Dollar:
                            {{convertNumberNEW(number_format($voucher->amount,2))}} {{convertdesi(extractFraction($voucher->amount))}} Only.
