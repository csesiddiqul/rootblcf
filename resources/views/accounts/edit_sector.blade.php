            ...
            <div class="col-md-8" id="main-container">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        @isset($sector)
                            <form action="{{route('accounts.sectors.update',['sector'=>$sector->id])}}"
                                  method="POST">
                                @csrf
                                @method('PATCH')
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control" name="name"
                                               value="{{$sector->name}}" placeholder="@lang('Sector Name')" required>
                                ...
                                <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                                    <label for="type" class="col-md-4 control-label">@lang('Sector Type')
                                        : {{ucfirst($sector->type)}} (@lang('Current'))</label>
