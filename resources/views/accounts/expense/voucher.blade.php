                    ...
                    <div align="center" class="con_margin">
                        ...
                        <div align="center" class="slip-content">
                            ...
                            <p class="font_10 special-box lucida"
                               style="font-family: sans-serif !important;text-align:center !important;font-size: 18px !important; margin-bottom:8px !important;margin-top:110px !important;">Payment  Voucher</p>
                        </div>
                    </div>
                ...
                <footer>
                    <div class="con_margin">
                        <div class="sans" style="text-transform: capitalize">
                            In Sum of SG
                            Dollar:{{convertNumberNEW(number_format($voucher->amount,2))}} {{convertdesi(extractFraction($voucher->amount))}} Only.
