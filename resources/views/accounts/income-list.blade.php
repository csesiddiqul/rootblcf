                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" style="margin-top: 5%;">
                                ...
                                @endif
                                <form class="row" id="registerForm" action="{{url('/accounts/list-income')}}"
                                      method="post">
                                    {{ csrf_field() }}
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('year') ? ' has-error' : '' }}">
                                            ...
                                            <input id="date" type="text" class="form-control datepicker" name="year"
                                                   value="{{ old('year') }}" placeholder="@lang('Year')" required>
                        ...
                        @isset($incomes)
                            <div class="table-responsive">
                                <table class="table table-data-div table-bordered table-hover">
                                    ...
                                    @foreach($incomes as $income)
                                        <tr>
                                            ...
                                            <td><a title='Edit' class='btn btn-info btn-sm'
                                                   href='{{url("accounts/edit-income")}}/{{$income->id}}'>@lang('Edit')</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                ...
                                <div id="printDiv" class="visible-print">
                                    ...
                                    <table style="border: 1px solid #888888;border-collapse: collapse;background-color: #f5f5f5;"
                                           cellpadding="5">
                                        <thead>
                                        <tr>
