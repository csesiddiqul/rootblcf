            ...
            <div class="col-md-{{ (\Auth::user()->role == 'master')? 12 : 10 }}" id="main-container">
                <div class="panel panel-default ">
                    <div class="panel-body pad-top-0">
                        {!! Form::model($user, ['route' => ['user.update', $user->student_code], 'method' => 'post','autocomplete'=>'off']) !!}
                        ...
                        @if($user->role == 'student')
                            ...
                            <div class="col-md-4 form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                                ...
                                {!! Form::text('birthday',Carbon\Carbon::parse($user->studentInfo['birthday'])->format('d-m-Y') ?? null , ['class' => 'form-control','id' => 'birthday','required']) !!}
                                @error('birthday')
                                <span class="help-block">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-4 form-group{{ $errors->has('house_id') ? ' has-error' : '' }}">
                                {!! Form::label('house_id', transMsg('House'), ['class' => 'control-label']) !!}
                        ...
                        @if($user->role == 'staff')
                            ...
                            <div class="col-md-4 form-group{{ $errors->has('school_id') ? ' has-error' : '' }}">
                                <label for="school_id" class="control-label">@lang('Branch')</label>
                                {!! Form::select('school_id',branchPluck(auth()->user()->school->id), old('school_id'), array('id' => 'school_id', 'class' => 'form-control', 'placeholder' => trans('Choose'))) !!}
