...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10" id="main-container">
            ...
            <h3>{{school('country')->code == 'BD' ? ' Subject Students of Class' : 'Course Students of Grade '}}:
                {{$student->student->section->class->name}} @lang('Section'):
                                ...
                                <td>
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            <input type="hidden" name="recipient_numbers[]" form="msgForm"
