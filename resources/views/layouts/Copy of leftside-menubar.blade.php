...
<ul class="nav flex-column">
    ...
    @if(Auth::user()->role != 'student')
        <li class="nav-item">
            <a class="nav-link" href="{{url('users/'.Auth::user()->school->code.'/1/0')}}"><i class="material-icons">settings</i>
    ...
    @if(Auth::user()->role == 'admin')
        <li class="nav-item">
            <a class="nav-link" href="{{route('school.class')}}"><i class="material-icons">open_in_new</i> <span
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{url('users/'.Auth::user()->school->code.'/0/1')}}"><i class="material-icons">contacts</i>
                <span class="nav-link-text">@lang('Team Members')</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{ route('committee.index') }}"><i class="material-icons">account_box</i>
                <span class="nav-link-text">@lang('Committee Members')</span></a>
        </li>
        <li class="nav-item">

            <a class="nav-link" href="{{ url('academic/notice') }}"><i class="material-icons">announcement</i> <span
                        class="nav-link-text">@lang('Communications')</span></a>
        </li>
        {{--<li class="nav-item">
            <a class="nav-link" href="{{ url('grades/all-exams-grade') }}"><i class="material-icons">grade</i> <span
                        class="nav-link-text">@lang('Grade Books')</span></a>
        </li>--}}

        <li class="nav-item">
            <a class="nav-link" href="{{ route('application.index') }}"><i class="material-icons">description</i> <span
                        class="nav-link-text">@lang('Applications')</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="#"><i class="material-icons">web</i> <span
                        class="nav-link-text">@lang('Website')</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{ route('settings.index') }}"><i class="material-icons">school</i> <span
                        class="nav-link-text">@lang('Institution')</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="#"><i class="material-icons">add_alert</i> <span
       ...
       {{-- <li class="nav-item dropdown">
        ...
        {{--<li class="nav-item">
            <a class="nav-link" href="{{ url('school/sections?course=1') }}"><i class="material-icons">class</i> <span
                        class="nav-link-text">@lang('Classes &amp; Sections')</span></a>
        </li>--}}
...
{{--
    ...
    @if(Auth::user()->role == 'student')
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('grade.each_student',Auth::user()->student_code) }}"><i class="material-icons">bubble_chart</i>
                <span
