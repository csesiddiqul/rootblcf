                        ...
                        <table class="table table-condensed" style="width:600px">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm" href="{{url('register/teacher')}}">+ @lang('Add Teacher')
                                        </a>
                                        <br>
                                        <h5>@lang('Or, Mass upload Excel')</h5>
                        ...
                        <table class="table table-condensed" style="width:400px">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">+@lang('Thana')</th>
                                    <th scope="col">+@lang('State')</th>
                                    <th scope="col">+@lang('ImportantLink')</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-sm" href="{{route('academic.division.index') }}">
                                            <i class="material-icons">developer_board</i> @lang('Upload Division')
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-info btn-sm" href="{{route('academic.district.index') }}">
                                            <i class="material-icons">developer_board</i> @lang('Upload District')
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-info btn-sm" href="{{route('academic.thana.index') }}">
                                            <i class="material-icons">developer_board</i> @lang('Upload Thana')
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-info btn-sm" href="{{route('academic.state.index') }}">
                                            <i class="material-icons">developer_board</i> @lang('Upload State')
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-info btn-sm" href="{{route('academic.importantLink.index') }}">
                                            <i class="material-icons">developer_board</i> @lang('ImportantLink')
                                        </a>
                                    </td>
                                </tr>
                            </tbody>
