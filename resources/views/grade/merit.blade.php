    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. url('exams').'">'. trans('Exams').'</a>  / <b>'. trans('Merit List').'<b>'])
                @include('components.sectionbar.examination-bar')
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div id="table-content" class="head-custom">
                                    ...
                                    @foreach($results as $result)
                                        @if ($result->fail == 0)
                                            <tr>
                                                ...
                                                <td>{{number_format(($result->fGpa > 5 ? 5 : $result->fGpa),2)}}</td>
