                                    ...
                                    <table class="table table-bordered" style="text-align: center">
                                        ...
                                        @foreach($results as $result)
                                            @if (!in_array($result->student_code,$student_array))
                                                @php array_push($student_array,$result->student_code);$pre_stu=$result->student_code;$sub_total=$sub_gpa=$subject_count=$optional_grade=0;$optional=$fail=false;$print_text=''; @endphp
                                                <tr>
                                                    <td>{{$key++}}</td>
                                                            ...
                                                            @foreach($results as $t_result)
                                                                @if($t_result->course_id == $course->id && $pre_stu == $t_result->student_code)
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        @elseif(isset(${"mcq" . $course->id}) && $td_ca)
                                                                            <td>0</td>
                                                                        @endif
                                                                    @endif
