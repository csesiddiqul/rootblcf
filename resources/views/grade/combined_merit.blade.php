    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. url('exams').'">'. trans('Exams').'</a>  / <b>'. trans('Combined Merit List').'<b>'])
                    ...
                    <div class="panel-body">
                      ...
                      <span class="pull-left">
                            ...
                            <div align="center">
                                ...
                                <h4>@lang('Combined Merit List')</h4>
                                <hr>
                            </div>
                            @php
                                    ...
                                    @foreach($results as $result)
                                        @if ($result->fail == 0)
                                            <tr>
                                                ...
                                                <td>{{number_format($result->fGpa,2)}}</td>
