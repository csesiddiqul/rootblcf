    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="main-container">
                @include('components.pages-bar',['pageTitle' =>'<a href="'. url('users/'.Auth::user()->school->code.'/1/0').'">'. trans('Students').'</a> / <a href="'. route('academic.category.index').'">'.trans('Student ').(school('country')->code == 'SG' ? 'Race' : 'Categories') .'</a> / <b>'. trans('Add').'<b>'])
                ...
                <div class="panel panel-default ptlb-515">
                    <div class="panel-body plt-07">
                        <form class="row" method="POST" id="registerForm"
                              action="{{ route('academic.category.store') }}">
                            {{ csrf_field() }}
                            <div class="col-md-6">
                            ...
                            <div class="col-md-2 text-center">
                                <a href="{{route('academic.category.index')}}"
