...
//        \RenatoMarinho\LaravelPageSpeed\Middleware\CollapseWhitespace::class,
    ...
    protected $routeMiddleware = [
        ...
        'master.agent' => \App\Http\Middleware\CheckMasterOrAgent::class,
        'master.admin.agent' => \App\Http\Middleware\CheckAdminOrAgentOrMaster::class,
        'master.admin.teacher' => \App\Http\Middleware\CheckAdminOrTeacherOrMaster::class,
        'admin.agent' => \App\Http\Middleware\CheckAdminOrAgent::class,
        ...
        'payroll' => \App\Http\Middleware\CheckPayroll::class,
        ...
        'main_academy' => \App\Http\Middleware\CheckMainAcademy::class
    ];
}
